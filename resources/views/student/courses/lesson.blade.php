                        ...
                        <div class="p-5">
                            ...
                            @elseif($block->type === 'video' && $block->file_path)
                                @if(auth()->user()->low_data_mode)
                                    <div class="rounded-xl overflow-hidden bg-gray-100 p-6 text-center border border-gray-200">
                                        <div class="text-3xl mb-2">📡</div>
                                        <h3 class="text-sm font-semibold text-gray-800">Video Hidden (Low Data Mode)</h3>
                                        <p class="text-xs text-gray-500 mb-4">You have Low Data Mode enabled. Video streaming is disabled to save bandwidth.</p>
                                        <a href="{{ $block->file_url }}" target="_blank" download class="text-sm bg-indigo-50 text-indigo-700 px-4 py-2 rounded-lg font-medium hover:bg-indigo-100 transition inline-block">
                                            Download Video
                                        </a>
                                    </div>
                                @else
                            ...
                            @elseif($lesson->file_type === 'video' && $lesson->file_path)
                                @if(auth()->user()->low_data_mode)
                                    <div class="rounded-xl overflow-hidden bg-gray-100 p-6 text-center border border-gray-200">
                                        ...
                                        <h3 class="text-sm font-semibold text-gray-800">Video Hidden (Low Data Mode)</h3>
                                        <p class="text-xs text-gray-500 mb-4">You have Low Data Mode enabled. Video streaming is disabled to save bandwidth.</p>
                                        <a href="{{ $lesson->file_url }}" target="_blank" download class="text-sm bg-indigo-50 text-indigo-700 px-4 py-2 rounded-lg font-medium hover:bg-indigo-100 transition inline-block">
                                            Download Video
                                        </a>
                                    </div>
                                @else
