                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-5">
                        ...
                        <div class="grid grid-cols-2 gap-2 mt-4">
                            ...
                            <a href="{{ route('teacher.quizzes.edit', $quiz->id) }}" class="w-full block text-center text-xs bg-blue-100 hover:bg-blue-200 text-blue-700 py-2 rounded-lg font-medium transition">
                                Edit
                            </a>
                            <a href="{{ route('teacher.quizzes.analytics', $quiz->id) }}" class="w-full block text-center text-xs bg-indigo-100 hover:bg-indigo-200 text-indigo-700 py-2 rounded-lg font-medium transition">
                                Analytics
                            </a>
                            <form method="POST" action="{{ route('teacher.quizzes.destroy', $quiz->id) }}"
                                  onsubmit="return confirm('Delete this quiz?')" class="w-full">
                                @csrf @method('DELETE')
