    ...
    <form method="POST"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div x-show="fileType !== 'text'">
                <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1.5">Upload File <span class="text-gray-400">(max 50MB)</span></label>
                ...
                @if(isset($lesson) && $lesson->file_path)
                    <p class="text-[10px] text-gray-400 font-semibold mt-1">Current file: {{ basename($lesson->file_path) }} (leave empty to keep)</p>
                @endif
            </div>

            <div x-show="fileType === 'video'">
                <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1.5">Video Duration (minutes)</label>
            ...
            <div x-show="fileType === 'text'" class="md:col-span-2">
                <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-1.5">Lesson Text Content</label>
