...
class EnrollmentTest extends TestCase
{
    ...
    {
        $student = \App\Models\User::factory()->create(['role' => 'student', 'status' => 'approved']);
        $course = \App\Models\Course::withoutEvents(function () {
            return \App\Models\Course::factory()->create(['price' => 0, 'status' => 'published']);
        });
    ...
    public function test_student_enrollment_starts_as_pending_for_paid_course()
    {
        $student = \App\Models\User::factory()->create(['role' => 'student', 'status' => 'approved']);
        $course = \App\Models\Course::withoutEvents(function () {
            return \App\Models\Course::factory()->create(['price' => 100, 'status' => 'published']);
        });
